...
| ------------- | ------------- |
| 0.1.5 - Jun 23, 2020 [v0.1.4](https://github.com/gertd/go-pluralize/releases/tag/v0.1.4) | 8.0.0 - Mar 14, 2020 [#e507706](https://github.com/blakeembrey/pluralize/commit/e507706be779612c06ebfd6043163e063e791d79)
...
To lock down a specific the version:
    ...
    go get -u github.com/gertd/go-pluralize@0.1.5
